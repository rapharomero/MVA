function dg = dualitygaps_LS(tau,X,y,mu,tol)
n = size(X,1);
d = size(X,2);
...
[primal_sol,primal_hist] = barr_method_LS(Q_primal, p_primal, A_primal, b_primal,x0,mu,tol);
...
[dual_sol,dual_hist] = barr_method_LS(Q_dual, p_dual, A_dual, b_dual,lambda0,mu,tol);
